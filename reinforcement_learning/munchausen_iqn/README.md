# MunchausenIQN training example

This is an example code for training models with [MunchausenIQN algorithm](https://arxiv.org/pdf/1806.06923.pdf) on nnabla.
...
```
$ python m_iqn_training_example.py
```
