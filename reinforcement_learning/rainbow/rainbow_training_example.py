...
from nnabla_rl.algorithms import Rainbow, RainbowConfig
...
class ExampleValueDistributionSolverBuilder(SolverBuilder):
    def build_solver(self, env_info, algorithm_config, **kwargs):
        config: RainbowConfig = algorithm_config
...
def train():
    ...
    # Adjust the replay_buffer_size through RainbowConfig if you do not have enough memory on your machine.
    ...
    rainbow.train(train_env, total_iterations=total_iterations)
