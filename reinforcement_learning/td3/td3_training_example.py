...
from nnabla_rl.algorithms import TD3, TD3Config
...
class ExamplePolicySolverBuilder(SolverBuilder):
    def build_solver(self, env_info, algorithm_config, **kwargs):
        config: TD3Config = algorithm_config
...
def train():
    ...
    gpu_id = 0
    config = TD3Config(gpu_id=gpu_id, learning_rate=1e-3,
    ...
    td3.train(train_env, total_iterations=total_iterations)
