...
def make_parser():
    ...
    parser.add_argument('--weights_path', type=str, default='./results/tmp/weight',
                        help='Path to trained model weights')
    parser.add_argument('--results_dir', type=str, default='./results/tmp/results',
                        help='Path to save results')
    parser.add_argument('--code_dir', type=str, default='./results/tmp/code',
                        help='Path to save results')
    parser.add_argument('--monitor_path', '-mp', type=str, default='./results/tmp/monitor',
                        help='Path to save results')
...
if __name__ == '__main__':
    ...
    if args.test:
        style_gan = Evaluate(monitor, config, args, comm)
