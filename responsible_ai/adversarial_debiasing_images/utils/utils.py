...
def plot_fairness_multi(DEO, BA, AAOD, accuracy, bar_x_axis="original"):
    """
    ...
    plot_fairness([BA], ax=axes[1], metric="BA",
                  title="Bias Amplification (BA)", bar_x_axis=bar_x_axis)
    plot_fairness([AAOD], ax=axes[2], metric="KL",
                  title="KL divergence", bar_x_axis=bar_x_axis)
    fig.text(0.92, 0.65, '\n'.join(
