...
class attribute_classifier():
    ...
    def __init__(self, batch_size=32, learning_rate=1e-4, max_iter=5086,
                 total_epochs=20, monitor_path=None,
                 val_weight=None, model_load_path=None):
        """
    ...
    def train(self, train_loader, val_loader):
        ...
        for epoch in range(self.total_epochs):
            ...
            if model_save:
                ...
                if (acc > self.acc):
                    path_best_acc = os.path.join(self.monitor_path, "best")
                    if not os.path.exists(path_best_acc):
                        os.makedirs(path_best_acc)
                    ...
                    with open(path_best_acc + '/val_scores.pkl', 'wb+') as handle:
                        pickle.dump(val_scores, handle)
                    with open(path_best_acc + '/val_targets.pkl', 'wb+') as handle:
                    ...
                    with open(path_best_acc + '/val_results.pkl', 'wb+') as handle:
