...
from model import loss_function, vgg16_prediction
...
def train():
    ...
    train_data_source = data_source_cifar10(
        train=True, shuffle=True, label_shuffle=args.shuffle_label
    )
    val_data_source = data_source_cifar10(
...
if __name__ == "__main__":
    ...
    monitor_path = os.path.join("./tmp.monitor", save_dir)
    ensure_dir(monitor_path)
