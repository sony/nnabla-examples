...
def get_args():
    """
     parse args
     """
    description = "Prejudice Remover Regularizer"
    ...
    parser.add_argument("--attr_path", type=str, default=r'./data/celeba/list_attr_celeba.txt',
                        help="celebA attribute file path and name (ex: ./data/list_attr_celeba.txt)")
    ...
    parser.add_argument("--learning-rate", "-l", type=float, default=1e-4,
                        help="learning rate is a critical hyperparameter in most learning algorithms")
    ...
    # Prejudice Remover Regularizer tuning parametr
    parser.add_argument('--eta', type=int, default=0,
                        help='parameter for prejudice remover')

    # save model
    parser.add_argument("--model-save-path", "-o",
                        type=str, default='./results', help='path where the model parameters are saved')
