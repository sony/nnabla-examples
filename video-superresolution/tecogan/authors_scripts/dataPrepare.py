...
parser = argparse.ArgumentParser(
    description='Process parameters.', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument('--start_id', default=2000, type=int,
                    help='starting scene index')
parser.add_argument('--duration', default=120, type=int, help='scene duration')
parser.add_argument('--disk_path', default="/mnt/netdisk/data/video/",
                    help='the path to save the dataset')
parser.add_argument('--summary_dir', default="",
                    help='the path to save the log')
parser.add_argument('--REMOVE', action='store_true',
                    help='whether to remove the original video file after data preparation')
parser.add_argument('--TEST', action='store_true',
                    help='verify video links, save information in log, no real video downloading!')
...
video_data_dict = {
    ...
    "40439273": [90, 520, 700, 1760, 2920, 3120, 3450, 4750, 4950, 5220, 6500, 6900, 9420, 9750],  # 1
    "87389090": [100, 300, 500, 800, 1000, 1200, 1500, 1900, 2050, 2450, 2900],  # 2
    "335874600": [287, 308, 621, 1308, 1538, 1768, 2036, 2181, 2544, 2749, 2867, 3404, 3543, 3842, 4318, 4439,
                  4711, 4900, 7784, 8811, 9450],  # 3
    "114053015": [30, 1150, 2160, 2340, 3190, 3555],  # 4
    "160578133": [550, 940, 1229, 1460, 2220, 2900, 3180, 4080, 4340, 4612, 4935,
                  5142, 5350, 5533, 7068],  # 5
    "148058982": [80, 730, 970, 1230, 1470, 1740],  # 6
    "150225201": [0, 560, 1220, 1590, 1780],  # 7
    "145096806": [0, 300, 550, 800, 980, 1500],  # 8
    "125621327": [240, 900, 1040, 1300, 1970, 2130, 2530, 3020, 3300, 3620, 3830, 4300, 4700, 4960],  # 9
    "162166758": [120, 350, 540, 750, 950, 1130, 1320, 1530, 1730, 1930],  # 10
    "115829238": [140, 450, 670, 910, 1100, 1380, 1520, 1720],  # 11
    # 12
    "159455925": [40, 340, 490, 650, 850, 1180, 1500, 1800, 2000, 2300, 2500, 2800, 3200],
    "193873193": [0, 280, 1720],  # 13
    # 14
    "133842385": [300, 430, 970, 1470, 1740, 2110, 2240, 2760, 3080, 3210, 3400, 3600],
    # 15
    "97692560": [0, 210, 620, 930, 1100, 1460, 1710, 2400, 2690, 3200, 3400, 3560, 3780],
    "142480565": [835, 1380, 1520, 1700, 2370, 4880],  # 16
    "174952003": [480, 680, 925, 1050, 1200, 1380, 1600, 1800, 2100, 2350, 2480, 2680, 3000, 3200, 3460, 4500, 4780,
                  5040, 5630, 5830, 6400, 6680, 7300, 7500, 7800],  # 17
    # 18
    "165643973": [300, 600, 1000, 1500, 1700, 1900, 2280, 2600, 2950, 3200, 3500, 3900, 4300, 4500],
    "163736142": [120, 400, 700, 1000, 1300, 1500, 1750, 2150, 2390, 2550, 3100, 3400, 3800, 4100, 4400, 4800, 5100, 5500, 5800, 6300],  # 19
    # 20
    "189872577": [0, 170, 340, 4380, 4640, 5140, 7300, 7470, 7620, 7860, 9190, 9370],
    "181180995": [30, 160, 400, 660, 990, 2560, 2780, 3320, 3610, 5860, 6450, 7260, 7440, 8830, 9020, 9220, 9390, ],  # 21
    "167892347": [220, 1540, 2120, 2430, 5570, 6380, 6740],  # 22
    "146484162": [1770, 2240, 3000, 4800, 4980, 5420, 6800],  # 23
    "204313990": [110],  # 24
    "169958461": [140, 700, 1000, 1430, 1630, 1900, 2400, 2600, 2800, 3000, 3200, 3600, 3900, 4200, 4600, 5000, 5700,
                  6000, 6400, 6800, 7100, 7600, 7900, 8200],  # 25
    "198634890": [200, 320, 440, 1200, 1320, 1560, 1680, 1800, 1920, 3445],  # 26
    "89936769": [1260, 1380, 1880],  # 27
}
...
for keys in video_data_dict:
    ...
    if info_dict["width"] < 400 or info_dict["height"] < 400:
        print("Skipped videos of small size %dx%d" %
...
print("Done: get %d valid folders with %d frames from %d videos." %
      (cur_id - Flags.start_id, Flags.duration, valid_video))
